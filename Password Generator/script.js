...
function updateStrengthBar() {
  ...
  switch (strength) {
    case 0:
      ...
      strengthBar.style.backgroundColor = "#f87171"; // danger-color
      break;
    case 1:
      strengthText.textContent = "Weak";
      strengthLabel.textContent = "1";
      strengthBar.style.backgroundColor = "#fb923c"; // orange
      break;
    case 2:
      strengthText.textContent = "Moderate";
      strengthLabel.textContent = "2";
      strengthBar.style.backgroundColor = "#fbbf24"; // warning-color
      break;
    case 3:
      strengthText.textContent = "Strong";
      strengthLabel.textContent = "3";
      strengthBar.style.backgroundColor = "#22d3ee"; // cyan
      break;
    default:
      strengthText.textContent = "Very Strong";
      strengthLabel.textContent = "4";
      strengthBar.style.backgroundColor = "#4ade80"; // success-color
      break;
  }
